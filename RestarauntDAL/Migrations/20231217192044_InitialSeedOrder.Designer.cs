...
namespace Restaraunt.Migrations
{
    ...
    [Migration("20231217192044_InitialSeedOrder")]
    partial class InitialSeedOrder
    {
            ...
            modelBuilder.Entity("Restaraunt.RestarauntSystem.DAL.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            DateOrder = new DateTime(2023, 12, 17, 21, 20, 43, 858, DateTimeKind.Local).AddTicks(2056),
                            Status = 0,
                            TableNumber = 1
                        });
                });
